...
ts.set_token('895b931bf65d2f2cece35a8936ec9531eed552bebc376ec091bf4298')
save_path = 'stock'
pro = ts.pro_api()


def getNoramlData(startdate,enddate):
...
def DataDownload():
    ...
    enddate = '20211226'
    #主程序
    getNoramlData(startdate = '20120101',enddate = '20211226')
    getLimitData()
